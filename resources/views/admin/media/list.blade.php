  ...
  <div class="min-height-200px">
    <div class="pd-20 card-box mb-30">
      <div class="clearfix mb-4">
        <div class="pull-left">
          <h3 class="text-blue h4">Danh sách hình ảnh</h3>
        </div>
        <div class="pull-right">
          <a href="{{ url('admin/media/add-media') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Thêm mới</a>
        </div>
      </div>
            <div class="pb-20">
              @if ($media->count() > 0)
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> 
                      ...
                      <img src="{{ asset('./uploads/images/media/'.$record->image) }}" width="100">
                      @endif
                    </td>
                    <td>
                      @if ($record->position == 1)
                      <span> Banner Center</span>
                      @else
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                          <a class="dropdown-item btn-edit" href="{{ url('admin/media/edit-media/'.$record->id) }}"><i class="dw dw-edit2"></i> Sửa</a>
