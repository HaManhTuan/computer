...
<div class="pd-ltr-20 xs-pd-20-10">
      <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
          ...
          <div class="pd-20">
           <form action="{{ url('admin/product/addProduct') }}" method="POST" id="form-add" enctype='multipart/form-data'>
            @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                  <input class="form-control" type="text" name="name" id="name" placeholder="Johnny Brown" data-rule-required="true" data-msg-required="Vui lòng nhập tên sản phẩm.">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Số lượng</label>
                <div class="col-sm-12 col-md-10">
                  <input type="text" id="stock" name="stock" class="form-control numbers" data-rule-required="true" data-msg-required="Vui lòng nhập số lượng." placeholder="Hãy nhập số lượng" onkeyup="this.value = number_format(this.value,0,'','.');" onblur="this.value = number_format(this.value,0,'','.')" value="">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Giá</label>
                <div class="col-sm-12 col-md-10">
                  <input type="text" id="price" name="price" class="form-control numbers" data-rule-required="true" data-msg-required="Vui lòng nhập giá." placeholder="Hãy nhập giá" onkeyup="this.value = number_format(this.value,0,'','.');" onblur="this.value = number_format(this.value,0,'','.')" value="">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Giá khuyến mại</label>
                <div class="col-sm-12 col-md-10">
                  <input type="text" id="promotional_price" name="promotional_price" class="form-control numbers" data-rule-required="true" data-msg-required="Vui lòng nhập giá km." placeholder="Hãy nhập giá km" onkeyup="this.value = number_format(this.value,0,'','.');" onblur="this.value = number_format(this.value,0,'','.')" value="0">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                  <textarea name="infor" class="form-control"></textarea>
                </div>
              </div>
                <script>
